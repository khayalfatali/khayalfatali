...
export function Footer() {
  return (
    <footer className="relative border-t border-white/10 bg-black py-16 md:py-24">
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid gap-12 md:grid-cols-[1.4fr_3fr] md:gap-16">
          <div>
            <div className="flex items-center gap-2">
              <YeriMark size={22} />
              <span className="text-[15px] font-medium tracking-tight text-white">Yeri</span>
            </div>
          ...
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
            {COLS.map((c) => (
              <div key={c.title}>
                <p className="mb-4 text-[12px] font-medium uppercase tracking-[0.15em] text-white/45">
                  {c.title}
                </p>
        ...
        <div className="mt-14 flex flex-wrap items-center justify-between gap-4 border-t border-white/10 pt-8 text-[12px] text-white/45">
          <p>© {new Date().getFullYear()} Yeri Payment Services LLC. All rights reserved.</p>
          <div className="flex gap-5">
            <a href="#" className="hover:text-white/75">Privacy</a>
            <a href="#" className="hover:text-white/75">Terms</a>
            <a href="#" className="hover:text-white/75">Cookies</a>
          </div>
        </div>
      </div>
    </footer>
